...
$filename = uniqid('animal_') . '.txt';

// Create the content of the text file
$fileContent = "Animal Name: $aname\nCage Number: $cnum";
...
if ($object) {
    echo '<script>alert("Animal detail has been added. Data also uploaded to Google Cloud Storage.")</script>';
} else {
    echo '<script>alert("Something Went Wrong. Please try again.")</script>';
}
}
